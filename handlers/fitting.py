...
markup3 = ReplyKeyboardBuilder([[button1]]).row(button2,width=5).row(button3, width=4)##.add(button3).add(button4).add(button5).add(button6).add(button7).add(button8).add(button9).add(button10)
