...
markup3 = ReplyKeyboardBuilder([[button1]]).add(button2).adjust(8,repeat=True).add(button3).adjust(repeat=True).as_markup()#.add(button3).add(button4).add(button5).add(button6).add(button7).add(button8).add(button9).add(button10)
