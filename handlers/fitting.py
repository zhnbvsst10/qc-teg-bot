...
markup3 = ReplyKeyboardBuilder.row(buttons=[button1, button2, button3, button4], width=10)
#([[button1]]).add(button2).adjust(repeat=True).add(button3).adjust(repeat=True).as_markup()#.add(button3).add(button4).add(button5).add(button6).add(button7).add(button8).add(button9).add(button10)
